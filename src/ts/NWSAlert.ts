...
export default class NWSAlert {
    ...
    getNamePriority(): number {
        ...
        switch (name) {
            ...
            case "red flag":
                return 45;
            case "hurricane local":
                return 46;
            case "typhoon local":
                return 47;
            case "tropical storm local":
                return 48;
            case "tropical depression local":
                return 49;
            case "winter weather":
                return 50;
            case "heat":
                return 51;
            case "urban and small stream flood":
                return 52;
            case "small stream flood":
                return 53;
            case "arroyo and small stream flood":
                return 54;
            case "hydrologic":
                return 55;
            case "heavy freezing spray":
                return 56;
            case "dense fog":
                return 57;
            case "dense smoke":
