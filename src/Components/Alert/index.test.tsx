...
describe("Notifications", () => {
    test.each([
        [
            "When a new alert is received, a notification is sent if permissions are granted",
            "granted",
        ],
        [
            "When a new alert is received, a notification is not sent if permissions aren't granted",
            "denied",
        ],
        ...
        if (state === "granted") {
            ...
            expect(Notification).toHaveBeenCalledWith(alert.get("event"), {
