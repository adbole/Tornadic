    ...
    features: [
        {
            ...
            properties: {
                ...
                headline:
                    "Severe Thunderstorm Warning issued September 12 at 8:12PM MDT until September 12 at 8:45PM MDT by NWS El Paso Tx/Santa Teresa NM",
                description:
                ...
                response: "Shelter",
                parameters: {
                    AWIPSidentifier: ["SVREPZ"],
                    WMOidentifier: ["WUUS54 KEPZ 130212"],
                    ...
                    "EAS-ORG": ["WXR"],
                    VTEC: ["/O.NEW.KEPZ.SV.W.0044.230913T0212Z-230913T0245Z/"],
                    eventEndingTime: ["2023-09-13T02:45:00+00:00"],
                },
            },
        },
    ],
...
//Polygons modified for testing purposes
export const all = {
    type: "FeatureCollection",
    features: [
        //Used for test where point may not be in forcast zone, but is within polygon
        {
            "id": "https://api.weather.gov/alerts/urn:oid:2.49.0.1.840.0.03a22a3eb595e0d1f431273aece83aa018a820f9.002.1",
            "type": "Feature",
            "geometry": {
                "type": "Polygon",
                "coordinates": [
            ...
            "properties": {
                "@id": "https://api.weather.gov/alerts/urn:oid:2.49.0.1.840.0.03a22a3eb595e0d1f431273aece83aa018a820f9.002.1",
                "@type": "wx:Alert",
                "id": "urn:oid:2.49.0.1.840.0.03a22a3eb595e0d1f431273aece83aa018a820f9.002.1",
                "areaDesc": "Dallas, TX",
                "geocode": {
                    "SAME": [
                        "048113"
                ...
                "references": [
                    {
                        "@id": "https://api.weather.gov/alerts/urn:oid:2.49.0.1.840.0.e9445782287a4bf7eaf1300d76501d0b5bf99bf5.001.1",
                        "identifier": "urn:oid:2.49.0.1.840.0.e9445782287a4bf7eaf1300d76501d0b5bf99bf5.001.1",
                        "sender": "w-nws.webmaster@noaa.gov",
                        "sent": "2024-03-08T12:58:00-06:00"
                    }
                ],
                "sent": "2024-03-08T18:48:00-06:00",
                "effective": "2024-03-08T18:48:00-06:00",
                "onset": "2024-03-08T18:48:00-06:00",
                "expires": "2024-03-09T08:30:00-06:00",
                "ends": "2024-03-09T08:24:00-06:00",
                "status": "Actual",
                "messageType": "Update",
                "category": "Met",
                "severity": "Severe",
                ...
                "parameters": {
                    ...
                    "VTEC": [
                        "/O.CON.KFWD.FL.W.0011.000000T0000Z-240309T1424Z/"
                    ],
                    "eventEndingTime": [
                        "2024-03-09T14:24:00+00:00"
                    ],
                    "expiredReferences": [
                        "w-nws.webmaster@noaa.gov,urn:oid:2.49.0.1.840.0.12e238dfc98174b49244c0b79c1d6eb85c19c26b.001.1,2024-03-07T08:01:00-06:00"
                    ]
                }
            }
        },
        {
            ...
            properties: {
                ...
                response: "None",
                parameters: {
                    AWIPSidentifier: ["KEPWBC"],
                    WMOidentifier: ["NZUS91 KWBC 130215"],
        ...
        },
        {
            ...
            properties: {
                ...
                references: [
                    {
                        ...
                        identifier:
                            "urn:oid:2.49.0.1.840.0.2973f1efbc4d6b6adfc78713eec120820e13205b.001.1",
                        sender: "w-nws.webmaster@noaa.gov",
                ...
                headline:
                    "Rip Current Statement issued September 12 at 10:15PM EDT until September 13 at 8:00PM EDT by NWS Charleston SC",
                description:
                ...
                response: "Avoid",
                parameters: {
                    AWIPSidentifier: ["CFWCHS"],
                    WMOidentifier: ["WHUS42 KCHS 130215"],
                    NWSheadline: [
                        "HIGH RIP CURRENT RISK REMAINS IN EFFECT THROUGH WEDNESDAY EVENING",
                    ],
                    BLOCKCHANNEL: ["EAS", "NWEM", "CMAS"],
                    VTEC: ["/O.CON.KCHS.RP.S.0009.000000T0000Z-230914T0000Z/"],
                    eventEndingTime: ["2023-09-14T00:00:00+00:00"],
                    expiredReferences: [
        ...
        //NEXT TWO MODIFIED FOR OVERLAPPING POLYGON TEST
        {
            id: "https://api.weather.gov/alerts/urn:oid:2.49.0.1.840.0.7b7a54584f6725c7883c2f41d52be172ea827776.001.1",
            type: "Feature",
            geometry: {
        ...
        },
        {
            ...
            properties: {
                ...
                affectedZones: ["https://api.weather.gov/zones/county/NVC017"],
                references: [
                    {
                        "@id": "https://api.weather.gov/alerts/urn:oid:2.49.0.1.840.0.92ae1a3be09da3da2f54f4091b429653f2fac733.001.1",
                        identifier:
                            "urn:oid:2.49.0.1.840.0.92ae1a3be09da3da2f54f4091b429653f2fac733.001.1",
                        sender: "w-nws.webmaster@noaa.gov",
                    ...
                    },
                    {
                        ...
                        identifier:
                            "urn:oid:2.49.0.1.840.0.29220c254fc98f9c5f1f094bce6f8255420f3c30.001.1",
                        sender: "w-nws.webmaster@noaa.gov",
                ...
                parameters: {
                    ...
                    BLOCKCHANNEL: ["EAS", "NWEM", "CMAS"],
                    "EAS-ORG": ["WXR"],
                    VTEC: ["/O.CON.KVEF.FF.W.0140.000000T0000Z-230913T0315Z/"],
                    eventEndingTime: ["2023-09-13T03:15:00+00:00"],
                },
            },
        },
        //END OF ALERTS FOR POLYGON TEST
        {
            ...
            properties: {
                ...
                geocode: {
                    SAME: ["055125", "055085", "055041", "055069"],
                    UGC: ["WIZ005", "WIZ010", "WIZ011", "WIZ018"],
                },
                affectedZones: [
                ...
                references: [
                    {
                        ...
                        identifier:
                            "urn:oid:2.49.0.1.840.0.6c466d4db82d0ece566921dc861ec32a67b73e6e.001.1",
                        sender: "w-nws.webmaster@noaa.gov",
                ...
                headline:
                    "Frost Advisory issued September 12 at 9:04PM CDT until September 13 at 8:00AM CDT by NWS Green Bay WI",
                description:
                ...
                response: "Prepare",
                parameters: {
                    AWIPSidentifier: ["NPWGRB"],
                    WMOidentifier: ["WWUS73 KGRB 130204"],
                    NWSheadline: [
                        "FROST ADVISORY REMAINS IN EFFECT FROM 2 AM TO 8 AM CDT WEDNESDAY",
                    ],
                    BLOCKCHANNEL: ["EAS", "NWEM", "CMAS"],
                    VTEC: ["/O.CON.KGRB.FR.Y.0006.230913T0700Z-230913T1300Z/"],
                    eventEndingTime: ["2023-09-13T13:00:00+00:00"],
                },
            },
        },
        {
            ...
            geometry: {
                ...
                coordinates: [
                    [
                        [-80.77, 34.12],
                        [-80.75999999999999, 34.14],
                        [-80.74, 34.15],
                        [-80.7099999, 34.159999899999995],
                        [-80.55, 34.169999999999995],
                        [-80.5, 34.129999999999995],
                        [-80.48, 34.10999999999999],
                        [-80.38000000000001, 34.07999999999999],
                        [-80.35000000000001, 34.04999999999999],
                        [-80.36000000000001, 34.01999999999999],
                        [-80.39000000000001, 33.96999999999999],
                        [-80.44000000000001, 33.92999999999999],
                        [-80.49000000000001, 33.89999999999999],
                        [-80.66000000000001, 33.919999999999995],
                        [-80.72000000000001, 33.94],
                        [-80.77000000000001, 33.96],
                        [-80.81000000000002, 33.99],
                        [-80.81999990000001, 34.04],
                        [-80.79, 34.089999999999996],
                        [-80.77, 34.12],
                    ],
                ],
            },
            properties: {
                ...
                geocode: {
                    SAME: ["045055", "045079", "045085"],
                    UGC: ["SCC055", "SCC079", "SCC085"],
                },
                affectedZones: [
                ...
                headline:
                    "Flood Advisory issued September 12 at 9:56PM EDT until September 13 at 1:00AM EDT by NWS Columbia SC",
                description:
                ...
                response: "Avoid",
                parameters: {
                    AWIPSidentifier: ["FLSCAE"],
                    WMOidentifier: ["WGUS82 KCAE 130156"],
                    NWSheadline: ["FLOOD ADVISORY IN EFFECT UNTIL 1 AM EDT WEDNESDAY"],
                    BLOCKCHANNEL: ["EAS", "NWEM", "CMAS"],
                    VTEC: ["/O.NEW.KCAE.FA.Y.0075.230913T0156Z-230913T0500Z/"],
                    eventEndingTime: ["2023-09-13T05:00:00+00:00"],
                },
            },
        },
        {
            ...
            properties: {
                ...
                references: [
                    {
                        ...
                        identifier:
                            "urn:oid:2.49.0.1.840.0.35342729a2ffc6d057b51b864d1d73be8ebf45ef.001.1",
                        sender: "w-nws.webmaster@noaa.gov",
                ...
                headline:
                    "Flood Watch issued September 12 at 9:43PM EDT until September 13 at 11:00AM EDT by NWS Baltimore MD/Washington DC",
                description:
                ...
                response: "Prepare",
                parameters: {
                    AWIPSidentifier: ["FFALWX"],
                    WMOidentifier: ["WGUS61 KLWX 130143"],
                    NWSheadline: ["FLOOD WATCH REMAINS IN EFFECT THROUGH WEDNESDAY MORNING"],
                    BLOCKCHANNEL: ["EAS", "NWEM", "CMAS"],
                    "EAS-ORG": ["WXR"],
                    VTEC: ["/O.CON.KLWX.FA.A.0011.230913T0300Z-230913T1500Z/"],
                    eventEndingTime: ["2023-09-13T15:00:00+00:00"],
                },
            },
        },
        {
            ...
            properties: {
                ...
                parameters: {
                    AWIPSidentifier: ["FFALWX"],
                    WMOidentifier: ["WGUS61 KLWX 130143"],
                    NWSheadline: ["FLOOD WATCH IN EFFECT THROUGH WEDNESDAY MORNING"],
                    BLOCKCHANNEL: ["EAS", "NWEM", "CMAS"],
                    "EAS-ORG": ["WXR"],
                    VTEC: ["/O.EXA.KLWX.FA.A.0011.230913T0300Z-230913T1500Z/"],
                    eventEndingTime: ["2023-09-13T15:00:00+00:00"],
                },
            },
        },
